            ...
            [
              function (callback) {
                ...
                request.get(addressLink, function (error, response, body) {
                  ...
                  var jsonBody = JSON.parse(body);
                  if (
                    jsonBody.status_code !== 500 &&
                    jsonBody._embedded.address[0] != null
                  ) {
                    order.address =
                      jsonBody._embedded.address[0]._links.self.href;
                  }
                  callback();
                });
              },
              function (callback) {
                ...
                request.get(cardLink, function (error, response, body) {
                  ...
                  if (
                    jsonBody.status_code !== 500 &&
                    jsonBody._embedded.card[0] != null
                  ) {
